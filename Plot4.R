...
with(powerfilter,{
  ...
  plot(powerfilter$Time, powerfilter$Voltage, type = "l", xlab = "datetime", ylab = "Voltage" )
  ...
  legend("topright",lty = 1,col=c("black","red","blue"),legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),text.font = 2, cex = 0.50, pt.cex = 1)
  plot(powerfilter$Time, powerfilter$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power" )
})
